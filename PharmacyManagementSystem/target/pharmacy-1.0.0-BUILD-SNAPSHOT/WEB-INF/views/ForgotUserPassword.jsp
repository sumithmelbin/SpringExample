		...
		<table width="850" border="0" cellspacing="0" cellpadding="0">
			<tr align="justify">
				...
				<td width="760" valign="top" align="center">
					<h1>USER EMAIL/PASSWORD ACESS</h1> <form:form method="POST"
						action="SendEmail" commandName="userpass">
						<table cellspacing="2" cellpadding="5" class="table">
							<form:errors path="*" cssClass="errorblock" element="div"></form:errors>
							<tr>
								<td>UserEmail</td>
								<td><form:input path="email" class="text" name="email" />
									<a href="addAdmin"><i><font color="blue"><center>Sign
													In</center></font></i></a></td>
							</tr>
							<table cellspacing="2" cellpadding="5">
								<tr>
									<input type="submit" class="button" value="Acess Password" />
								</tr>
