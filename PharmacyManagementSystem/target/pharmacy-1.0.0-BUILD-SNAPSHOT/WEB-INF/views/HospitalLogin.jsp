...
<body>
	...
	<section class="contact1">
		<div class="navigation">
			...
			<div class="divloginfortable">
				<form:form method="POST" action="HospitalLoginCheck"
					commandName="admin">

					<table class="table">
						<tr>
							<form:errors path="*" cssClass="errorblock" element="div"></form:errors>
							<h3 class="heading">${msg}</h3>
						<tr>
						<tr>
							<h2 align="center">LOGIN</h2>
						</tr>
						<tr>
							<td><form:label class="label" path="name">User ID</form:label></td>
